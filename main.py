...
datasetpath = os.path.join(base_path, 'Dataset', 'Benchmark Dataset')
exp_file = os.path.join(datasetpath, f"{net_type} Dataset", data_type, f"TFs+{args.num}", "BL--ExpressionData.csv")
tf_file = os.path.join(datasetpath, f"{net_type} Dataset", data_type, f"TFs+{args.num}", "TF.csv")
target_file = os.path.join(datasetpath, f"{net_type} Dataset", data_type, f"TFs+{args.num}", "Target.csv")

train_file = os.path.join(base_path, net_type, f"{data_type} {args.num}", "Train_set.csv")
val_file = os.path.join(base_path, net_type, f"{data_type} {args.num}", "Validation_set.csv")
test_file = os.path.join(base_path, net_type, f"{data_type} {args.num}", "Test_set.csv")
...
model = GeneKAN(input_dim=feature.size()[1],
